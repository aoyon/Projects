...
;Graph.c,47 :: 		s4=s4/2.06;
	...
	MOVF       R0+1, 0
	MOVWF      _s4+1
;Graph.c,48 :: 		sprinti(line,"%03d*%03d*%03d*%03d",s1,s2,s3,s4);
	MOVLW      _line+0
	...
	CALL       _sprinti+0
;Graph.c,49 :: 		UART1_Write_Text(line);
	MOVLW      _line+0
	MOVWF      FARG_UART1_Write_Text_uart_text+0
	CALL       _UART1_Write_Text+0
;Graph.c,50 :: 		UART1_Write_Text("\n");
	MOVLW      ?lstr2_Graph+0
	MOVWF      FARG_UART1_Write_Text_uart_text+0
	CALL       _UART1_Write_Text+0
;Graph.c,51 :: 		Delay_ms(200);
	MOVLW      6
	MOVWF      R11+0
	MOVLW      19
	MOVWF      R12+0
