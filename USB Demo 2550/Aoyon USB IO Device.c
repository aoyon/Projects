...
ADCON1 = 0b00001010;                       // Analog Channel AN0,AN1,AN2,AN3,AN4 are active all other Analog channel are Digital
...
HID_Enable(&readbuff,&writebuff);         // Enable HID communication
  ...
  else
  {
   ...
   /* Temp Module Disabled
   temp = ADC_Read(4);
   temp = temp/2;
   writebuff[50] = (char)temp;
   writebuff[51] = (char)(temp >> 8);
   Temp Module Disabled */
